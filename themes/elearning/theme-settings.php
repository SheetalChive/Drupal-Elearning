...
/**
 * @file
 * Custom setting for elearning theme.
 */
function elearning_form_system_theme_settings_alter(&$form, &$form_state) {
  $theme_path = drupal_get_path('theme', 'elearning');
  $image_folder = $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'elearning') . '/images/theme-settings/';
  $button = "display: inline-block; background: #0984e3; color: white; margin-bottom: 10px; padding: 5px 10px";
  $elearningpro = '<img src="' . $image_folder . 'elearningpro.png" />';
	$form['#attached']['library'][] = 'elearning/theme-settings';
  $form['elearning'] = [
    '#type'       => 'vertical_tabs',
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thank you for using elearning Theme</h3><strong>Edu X</strong> is a free Drupal 8, 9 theme designed and developed by <a href="https://www.drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'elearning',
  ];
  $form['layout'] = [
    '#type'  => 'details',
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://www.drupar.com/theme/elearning" target="_blank">Theme Homepage</a> || <a href="https://demo2.drupar.com/elearning/" target="_blank">Theme Demo</a> || <a href="https://www.drupar.com/doc/elearning" target="_blank">Theme Documentation</a> || <a href="https://www.drupar.com/doc/elearning/support" target="_blank">Theme Support</a>'),
  ];
  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To Edu-X-Pro for $29 only'),
    '#description' => t('<p><a href="https://www.drupar.com/theme/elearningpro" target="_blank">Purchase Edu-X-Pro</a> || <a href="https://demo2.drupar.com/elearningpro/" target="_blank">Edu-X-Pro Demo</a></p>') . $elearningpro,
  ];
  /*
   * Layout
   */
  ...
  $form['slider']['slider_image_section']['slider_image_bg'] = [
    ...
    '#default_value' => theme_get_setting('slider_image_bg', 'elearning'),
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#default_value'  => theme_get_setting('slider_image', 'elearning'),
    '#description'   => t('elearning theme has limitation of single image for slider. Separate image for each slide is available in elearningPro. <a href="https://www.drupar.com/theme/elearningpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
  ];
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code'),
    '#description'   => t('Please refer to this <a href="https://www.drupar.com/doc/elearning/homepage-slider" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  /*
   * Header
   */
  ...
  $form['header']['header_links']['header_links_section'] = [
    '#type'        => 'fieldset',
    '#description'   => t('<a href="https://www.drupar.com/doc/elearning/how-manage-website-logo" target="_blank">Change Logo</a> || <a href="https://www.drupar.com/doc/elearning/how-change-favicon-icon" target="_blank">Change Favicon Icon</a> || <a href="https://www.drupar.com/doc/elearning/header-main-menu" target="_blank">Manage Main Menu</a> || <a href="https://www.drupar.com/doc/elearning/sliding-search-form" target="_blank">Sliding Search Form</a>'),
  ];
  // Header -> Login Links
  ...
  $form['header']['sticky_header'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/elearningpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
    '#group' => 'header_tab',
  ];
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_color'] = [
    ...
    '#description'   => t('Color option is available in the premium version of this theme. <a href="https://www.drupar.com/theme/elearningpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
    '#open' => TRUE,
  ];
  /*
   * Content
  ...
  $form['content']['shortcodes'] = [
    '#type'          => 'details',
    '#title'         => t('Shortcodes'),
    '#description'   => t('<p>elearning theme has many custom shortcodes which you can use for creating contents.</p><p>Please visit this page for list of all available shortcodes and how to use these shortcodes.</p><ul><li><a href="https://www.drupar.com/node/1283/" target="_blank">Edu-X Shortcodes</a></li><li><a href="https://www.drupar.com/node/1211/" target="_blank">The-X Shortcodes</a></li></ul><p><hr /></p><h4>More Shortcodes</h4><p><a href="https://www.drupar.com/theme/elearningpro">Edu-X-Pro</a> has more custom shortcodes like Tab, Accordion, icon box, card, Model etc.'),
    '#group' => 'content_tab',
  ];
  // content -> RTL
  ...
  $form['content']['content_direction']['rtl'] = [
    ...
    '#disabled'   => TRUE,
    //'#description'   => t('elearning theme is Right-to-left (RTL) languages compatible. Check this option to enable RTL. This feature is currently under testing phase. So, this may not work perfectly.'),
  ];
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#description'   => t("Check this option to show website copyright text in footer. Uncheck to hide.<br />Read more: <a href='https://www.drupar.com/doc/elearning/copyright-text-footer' target='_blank'>Copyright Text in Footer</a>"),
  ];
  ...
  $form['components']['fonts']['fonts_section']['font_src'] = [
    ...
    '#description'   => t('elearning theme uses following Google fonts: Noto Sans.<br />You can serve these fonts locally or from Google server.'),
  ];
  // Components -> Social
  ...
  $form['components']['social']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description'   => t('<h3>Share Page On Social networking websites</h3><p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/elearningpro" target="_blank">Buy Edu-X-Pro for $29 only.</a></p>'),
    '#group' => 'components_tab',
  ];
  ...
  $form['components']['font_icons']['materialicons'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/elearningpro" target="_blank">Purchase Edu-X-Pro for $29 only.</a>'),
  ];
  ...
  $form['insert_codes']['head'] = [
    '#type'        => 'details',
    '#title'       => t('Head'),
    '#description' => t('<h3>Insert Codes Before &lt;/HEAD&gt;</h3><p><hr /></p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/elearningpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
  ...
  $form['insert_codes']['css']['css_section']['styling'] = [
    ...
    '#description'   => t("Check this option to enable custom styling. Uncheck to disable this feature.<br />Please refer to this tutorial page. <a href='https://www.drupar.com/doc/elearning/custom-css' target='_blank'>How To Use Custom Styling</a>"),
  ];
  ...
  $form['insert_codes']['css']['css_section']['styling_code'] = [
    ...
    '#description'   => t('Please enter your custom css codes in this text box. You can use it to customize the appearance of your site.<br />Please refer to this tutorial for detail: <a href="https://www.drupar.com/doc/elearning/custom-css" target="_blank">Custom CSS</a>'),
  ];
  ...
  $form['support']['info'] = [
    ...
    <p>Please check our documentation for detailed information on how to use Edu-X theme.<br /><a href="https://www.drupar.com/doc/elearning" target="_blank">Edu X Documentation</a>.</p>
    ...
    <hr />
    <h4>Create Issue</h4>
    <p>If you need support that is beyond our theme documentation, please <a href="https://www.drupal.org/project/issues/elearning?status=All&categories=All" target="_blank">Create an issue</a> at project page.</p>
    <hr />
    <h4>Contact Us</h4>
  ...
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<p><a href="https://demo2.drupar.com/elearningpro/" target="_blank">elearningPro Demo</a> | <a href="https://www.drupar.com/theme/elearningpro" target="_blank">Purchase elearningPro for $29 only</a></p>'),
    '#description' => t("$elearningpro"),
  ];
// End form.
}
