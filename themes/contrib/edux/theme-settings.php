...
function edux_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['edux'] = [
    '#type'       => 'vertical_tabs',
    '#title'      => '<h3 class="settings-form-title">' . t('eduX Theme Settings') . '</h3>',
    '#default_tab' => 'general',
  ];
  /**
   * Main Tabs.
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thanks for using eduX Theme</h3>eduX is a free Drupal 8, 9 theme designed and developed by <a href="https://drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'edux',
  ];
  $form['layout'] = [
    '#type'  => 'details',
  ...
  $form['upgrade'] = [
    '#type'  => 'details',
    '#title' => t('Upgrade To eduX Pro'),
    '#description'  => t('<h3>Upgrade To eduX Pro For $19 only.</h3>'),
    '#group' => 'edux',
  ];
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://www.drupar.com/theme/edux" target="_blank">Theme Homepage</a> || <a href="//demo2.drupar.com/edux/" target="_blank">Theme Demo</a> || <a href="https://www.drupar.com/edux-documentation" target="_blank">Theme Documentation</a> || <a href="https://www.drupar.com/edux-documentation/support" target="_blank">Theme Support</a>'),
  ];
  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To eduX Pro for $19 only'),
    '#description' => t('<a href="https://www.drupar.com/theme/eduxpro" target="_blank">Purchase eduX Pro</a> || <a href="//demo2.drupar.com/eduxpro/" target="_blank">eduX Pro Demo</a>'),
  ];
  /*
   * Layout
   */
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#description'   => t('edux theme has limitation of single image for slider. Separate image for each slide is available in eduxPro. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy eduxPro for $19 only.</a>'),
  ];
  ...
  $form['header']['header_main']['header_main_section']['header_main_padding_top'] = [
    ...
    '#description'   => t("Default padding top is 1rem which is equivalent to 16px.<br /><br /><p><hr /></p><br />"),
  ];
  $form['header']['header_main']['header_main_section']['header_main_padding_bottom'] = [
    ...
    '#description'   => t("Default padding bottom is 1rem which is equivalent to 16px."),
  ];
  // header-> page header
  ...
  $form['header']['header_page']['header_page_section']['header_page_padding_top'] = [
    ...
    '#description'   => t("Default padding top is 4rem<br /><br /><p><hr /></p>"),
  ];
  $form['header']['header_page']['header_page_section']['header_page_padding_bottom'] = [
    ...
    '#description'   => t("Default padding bottom is 2rem."),
  ];
  ...
  $form['sidebar']['animated_sidebar'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy eduxPro for $19 only.</a>'),
    '#group' => 'sidebar_tab',
  ];
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_section']['sidebar_radius'] = [
    ...
    '#max'  => 50,
    '#step' => 1,
    '#title'  => t('Sidebar Border Radius (px)'),
  ...
  $form['elements']['logo']['site_name']['site_name_size'] = [
    ...
    '#description'   => t("Default value is <strong>2.6rem</strong>.<br />1 rem = 16px<br />Default size is 1rem.<br /><br /><p><hr /></p>"),
  ];
  ...
  $form['elements']['main_menu']['main_menu_top']['main_menu_top_size'] = [
    ...
    '#description'   => t("Default value is <strong>1rem</strong>.<br />1 rem = 16px<br />Default size is 1rem.<br /><br /><p><hr /></p>"),
  ];
  ...
  $form['elements']['page_title']['page_title_size_section']['page_title_size_desktop'] = [
    ...
    '#max'  => 5,
    '#step' => 0.1,
    '#title'  => t('Desktop and Laptop'),
    '#default_value' => theme_get_setting('page_title_size_desktop', 'edux'),
    '#description'   => t("Default value is <strong>2.6rem</strong>.<br />1 rem = 16px<br />Default size is 1rem."),
  ];
  $form['elements']['page_title']['page_title_size_section']['page_title_size_mobile'] = [
    ...
    '#max'  => 5,
    '#step' => 0.1,
    '#title'  => t('Mobile and Tablet'),
    '#default_value' => theme_get_setting('page_title_size_mobile', 'edux'),
    '#description'   => t("Default value is <strong>2.2rem</strong>.<br />1 rem = 16px<br />Default size is 1rem."),
  ];
  ...
  $form['elements']['button']['button_section']['button_padding'] = [
    ...
    '#description'   => t("Padding of button. Example: <strong>5px 10px 5px 10px</strong>"),
  ];
  $form['elements']['button']['button_section']['button_radius'] = [
    ...
    '#description'   => t("Border radius of buttons. Default value is 0"),
  ];
  /*
   * Components
   */
  ...
  $form['components']['social']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description'   => t('<h3>Share Page On Social networking websites</h3><p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy eduxPro for $19 only.</a></p>'),
    '#group' => 'components_tab',
  ];
  ...
  $form['components']['font_icons']['fontawesome4']['fontawesome_four'] = [
    ...
    '#description'   => t('Check this option to enable fontawesome_four font icons.'),
  ];
  ...
  $form['components']['scrolltotop']['scrolltotop_icon']['scrolltotop_icon_style'] = [
    '#type'          => 'radios',
    '#title'         => t('Select Arrow Icon'),
    '#options' => array(
      'arrow-one.svg' => t($img_arrow_one . '<br /><br />'),
      '&#129121;' => t('<span style="font-size: 3rem">&#129121;</span><br /><br />'),
      'arrow-two.svg' => t($img_arrow_two . '<br /><br />'),
      '&#x21e1;' => t('<span style="font-size: 3rem; font-weight: 700">&#x21e1;</span><br /><br />'),
      '&#11165;' => t('<span style="font-size: 3rem">&#11165;</span><br /><br />'),
      '&#129041;' => t('<span style="font-size: 3rem">&#129041;</span><br /><br />'),
      '&#9650;' => t('<span style="font-size: 3rem">&#9650;</span><br /><br />'),
    ),
  ...
  $form['components']['scrolltotop']['scrolltotop_shape_section']['scrolltotop_icon_size'] = [
    ...
    '#description' => t('Default value is 24px.<p><hr /></p>'),
  ];
  ...
  $form['css']['custom']['styling'] = [
    ...
    '#description'   => t("Check this option to enable custom styling. Uncheck to disable this fearure.<br />Please refer to this tutorial page. <a href='https://www.drupar.com/edux-documentation/custom-css' target='_blank'>How To Use Custom Styling</a>"),
  ];

  $form['css']['custom']['styling_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Additional CSS Codes'),
    '#default_value' => theme_get_setting('styling_code', 'edux'),
    '#description'   => t('Add your own CSS code here to customize the appearance of your site.<br />Please refer to this tutorial for detail: <a href="https://www.drupar.com/edux-documentation/custom-css" target="_blank">Custom CSS</a>'),
  ];

  // Settings under support tab.
  $form['support']['info'] = [
    '#type'        => 'fieldset',
    '#title'         => t('edux Theme Support'),
    '#description' => t('<h4>Documentation</h4>
    <p>Please check our full documentation for detailed information on how to use edux theme.<br />Please read the <a href="https://www.drupar.com/edux-documentation" target="_blank">edux Theme Documentation</a>.</p>
    <hr />
    <h4>Create Issue</h4>
    ...
    <hr />
    <h4>Contact Us</h4>
    <p>If you need some specific customizations in theme or need custom Drupal theme development, please contact us<br><a href="https://www.drupar.com/contact" target="_blank">drupar.com/contact</a></p>'),
  ];

  // Settings under upgrade tab.
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<a href="https://demo2.drupar.com/eduxpro/" target="_blank">eduxPro Demo</a> | <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Purchase eduxPro for $19 only</a>'),
  ];
// End form.
}
