// $(document).ready(function(){
    ...
    $('.register-form').addClass('container');
    $('.register-form').addClass('row');
    $(".form-item-title").addClass('col-md-12');
    $(".form-item-email").addClass('col-md-6');
    $(".form-item-password").addClass('col-md-6');
    $(".form-select").addClass('form-control');
    $(".form-item-role").addClass('col-md-6');
    $(".form-item-course").addClass('col-md-6');
    $(".js-form-item-mobile").addClass('col-md-6');
    // $(".form-submit").addClass('form-control');
    $(".js-form-item-help").addClass('col-md-12');
    $('.ftco-no-pt ').addClass('container');
    ...
    $(".h5p-iframe-wrapper").addClass('container');
    ...
    //     $( "#block-login-link" ).html("<p><a href='user/logout'><span>Logout</span> </a></p>");
